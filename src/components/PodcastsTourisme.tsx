...
const PodcastsTourisme: React.FC = () => {
  ...
  const VideoCard = ({ episode }: { episode: VideoEpisode }) => {
    ...
    return (
      <div
        className={`bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border group ${episode.featured ? 'border-2 border-cyan-600' : 'border-gray-200'
          }`}
      >
        {episode.featured && (
        ...
        <div className="p-6">
          ...
          <h4 className="font-bold text-md text-gray-900 mb-3 group-hover:text-cyan-600 transition-colors line-clamp-2">
            {episode.title}
          </h4>
          ...
          <div className="text-center text-white">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6">
              ...
              <div className="relative group">
                <div className="flex items-center gap-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-6 py-4 shadow-2xl transition-all duration-500 hover:bg-white/15 hover:border-white/30">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-3 sm:p-4">
                  ...
                  <div className="mb-3 sm:mb-4 px-1 sm:px-2">
                    ...
                    >
                      ...
                      <div
                        className="absolute h-full bg-cyan-600 rounded-full transition-all duration-100"
                        style={{ width: `${progress}%` }}
                      ></div>
                      <div
                        className="absolute top-1/2 w-3 h-3 bg-cyan-600 rounded-full transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-lg"
                ...
                <div className="p-3 sm:p-4 border-b border-gray-700">
                  <div className="flex items-center space-x-3 mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400">Vidéos éducatives</div>
                    </div>
                  </div>
