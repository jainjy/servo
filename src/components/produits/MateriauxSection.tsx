...
const MateriauxSection = ({
  ...
  return (
    <div className="bg-[#FFFFFF]/70 p-5 pb-14 my-5 rounded-lg" id="materiaux">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-xs lg:text-sm text-[#8B4513] mt-1">
              Matériaux de construction et fournitures pour tous vos projets de
              rénovation
            </p>
          </div>
        </div>
      ...
      {isLoading ? (
        <div className=" py-12 flex flex-col justify-center items-center">
          ...
          <p className="text-[#8B4513] mt-4">Chargement des matériaux...</p>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {sortedCategories.map((category, index) => {
              ...
              return (
                <Card
                  key={category.name}
                  className="group p-6 border-0 bg-[#FFFFFF]/80 backdrop-blur-md shadow-xl hover:shadow-2xl transition-all duration-500 cursor-pointer border-[#D3D3D3]/20 text-center animate-slide-from-right-card"
                  style={{
                ...
                >
                  ...
                  <p className="text-[#8B4513] text-xs mb-4 leading-relaxed">
                    {category.description}
                  </p>
                  <Button
                    className="w-full border bg-transparent hover:bg-[#6B8E23] hover:text-white text-[#556B2F] transition-all duration-300 group-hover:shadow-lg"
