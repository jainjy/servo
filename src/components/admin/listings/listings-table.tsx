  ...
  if (error) {
    return (
      <Card
        ...
        style={{ backgroundColor: "#FFFFFF0", borderColor: "#D3D3D3" }}
      >
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute top-2 left-2">
                      <Badge
                        className={`text-xs ${
                          STATUT_ANNONCE[listing.status]?.color
                        }`}
                      >
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <Badge
                        className={
                          STATUT_ANNONCE[selectedListing.status]?.color
                        }
                      >
