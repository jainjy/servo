    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div className="bg-white p-4 rounded-lg shadow border">
          ...
          <p className="text-2xl font-bold text-gray-900">{stats.totals?.conseils || 0}</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow border">
          <h3 className="text-sm font-medium text-gray-500">En Vedette</h3>
          <p className="text-2xl font-bold text-amber-600">{stats.totals?.featured || 0}</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow border">
          <h3 className="text-sm font-medium text-gray-500">Vues Total</h3>
          <p className="text-2xl font-bold text-blue-600">{stats.totals?.views?.toLocaleString() || 0}</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow border">
          <h3 className="text-sm font-medium text-gray-500">Sauvegardes</h3>
          <p className="text-2xl font-bold text-emerald-600">{stats.totals?.saves?.toLocaleString() || 0}</p>
        </div>
      </div>
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm">
                      <div className="flex items-center">
                        ...
                        {conseil.stats?.views || 0}
                      </div>
                      <div className="flex items-center mt-1">
                        <svg className="w-4 h-4 text-gray-400 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        {conseil.stats?.saves || 0}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
