...
const MetierForm = ({ metier, onSubmit, onCancel, loading = false, isOpen = false }) => {
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              {metier ? 'Modifiez les informations du métier' : 'Remplissez les informations pour créer un nouveau métier'}
            </p>
          </div>
          <button
            onClick={onCancel}
          ...
          <div className="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-200">
            ...
            >
              {loading ? (
                ...
                <>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={metier ? "M5 13l4 4L19 7" : "M12 4v16m8-8H4"} />
                  </svg>
