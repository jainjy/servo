...
const PodcastsPartenaires: React.FC = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      Partenaires: "bg-gradient-to-r from-green-500 to-emerald-500",
      ...
      Témoignage: "bg-gradient-to-r from-indigo-500 to-purple-500",
      Interview: "bg-gradient-to-r from-red-500 to-pink-500",
    };
    ...
    return (
      <div
        className={`bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border group ${
          episode.featured ? "border-2 border-green-600" : "border-gray-200"
        }`}
      >
        {episode.featured && (
          <div className="bg-green-600 text-white px-4 py-1 text-sm font-semibold rounded-t-2xl">
            ⭐ Partenaire Premium
          </div>
        )}
        ...
        <div className="p-6">
          ...
          <h4 className="font-bold text-lg text-gray-900 mb-3 group-hover:text-green-600 transition-colors line-clamp-2">
            {episode.title}
          </h4>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <button
              ...
              className="flex items-center px-4 py-2 rounded-lg text-white bg-green-600 hover:bg-green-700 transition-colors group/btn"
            >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <h1 className="text-2xl lg:text-4xl font-bold mb-6 leading-tight">
              Podcast <span className="text-green-400">Partenaires</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 lg:gap-8 text-gray-200">
              ...
              <div className="glass-card group p-4 lg:p-6 rounded-2xl backdrop-blur-md border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="flex items-center space-x-3">
                  <div className="p-2 lg:p-3 rounded-xl bg-green-500/20 border border-green-400/30 group-hover:bg-green-500/30 transition-colors duration-300">
                    <Users className="w-5 h-5 lg:w-6 lg:h-6 text-green-300" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xl lg:text-2xl font-bold text-white drop-shadow-lg">
              ...
              <div className="glass-card group p-4 lg:p-6 rounded-2xl backdrop-blur-md border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="flex items-center space-x-3">
                  <div className="p-2 lg:p-3 rounded-xl bg-amber-500/20 border border-amber-400/30 group-hover:bg-amber-500/30 transition-colors duration-300">
                    <Handshake className="w-5 h-5 lg:w-6 lg:h-6 text-amber-300" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xl lg:text-2xl font-bold text-white drop-shadow-lg">
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-3 sm:p-4 border-t border-gray-700 bg-gray-900/50">
                  <div className="flex space-x-2">
                    <button
                      onClick={handlePlayMedia}
                      className="flex-1 flex items-center justify-center space-x-2 bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-semibold transition-all duration-200 text-xs sm:text-sm"
                    >
                      {isPlaying ? (
                        <>
                          <svg
