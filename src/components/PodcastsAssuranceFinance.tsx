...
const PodcastsAssuranceFinance: React.FC = () => {
  ...
  // Image de background pour le titre (remplacez par votre image)
  const headerBackgroundImage = "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80";
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              Assurance <span className="text-blue-400">&</span> Finance
            </h1>
          ...
          <section className="mb-16">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-gray-900">Podcasts Finance</h2>
                  <p className="text-gray-600">Écoutez nos experts en finance et assurance</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Apprenez avec nos vidéos éducatives</p>
                </div>
              </div>
              <div className="text-sm text-gray-500 bg-white px-4 py-2 rounded-full border">
