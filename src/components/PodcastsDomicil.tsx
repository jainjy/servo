              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-4 border-b border-gray-700">
                  <div className="flex items-center space-x-3 mb-3">
                    {/* Avatar */}
                    <div className="w-10 h-10 bg-gradient-to-br from-yellow-500 to-yellow-500 rounded-full flex items-center justify-center shadow-lg">
                      {selectedEpisode.mediaType === 'video' ? (
                ...
                <div className="p-4 border-b border-gray-700">
                  <div className="flex space-x-2">
                    {selectedEpisode.mediaType === 'video' ? (
                      <button
                        onClick={handlePlayMedia}
                        className="flex-1 flex items-center justify-center space-x-2 bg-yellow-500 hover:bg-yellow-700 text-white py-2 rounded-lg font-semibold transition-all duration-200"
                      >
                        {isPlaying ? (
                          <>
