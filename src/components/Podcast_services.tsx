        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 lg:gap-8 text-gray-200">
              ...
              <div className="glass-card group p-4 lg:p-6 rounded-2xl backdrop-blur-md border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs lg:text-sm text-gray-300 opacity-80">vues totales</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card group p-4 lg:p-6 rounded-2xl backdrop-blur-md border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="flex items-center space-x-3">
                  <div className="p-2 lg:p-3 rounded-xl bg-purple-500/20 border border-purple-400/30 group-hover:bg-purple-500/30 transition-colors duration-300">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs lg:text-sm text-gray-300 opacity-80">vidéos disponibles</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-card group p-4 lg:p-6 rounded-2xl backdrop-blur-md border border-white/10 bg-white/5 hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                <div className="flex items-center space-x-3">
                  <div className="p-2 lg:p-3 rounded-xl bg-amber-500/20 border border-amber-400/30 group-hover:bg-amber-500/30 transition-colors duration-300">
                    <Building className="w-5 h-5 lg:w-6 lg:h-6 text-amber-300" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-xl lg:text-2xl font-bold text-white drop-shadow-lg">
                      {videoEpisodes.filter(ep => ep.featured).length}
                    </span>
                    <span className="text-xs lg:text-sm text-gray-300 opacity-80">vidéos premium</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-3 sm:p-4 border-t border-gray-700 bg-gray-900/50">
                  <div className="flex space-x-2">
                    <button
                      onClick={handlePlayMedia}
                      className="flex-1 flex items-center justify-center space-x-2 bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg font-semibold transition-all duration-200 text-xs sm:text-sm"
                    >
                      {isPlaying ? (
                        <>
