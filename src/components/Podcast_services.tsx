...
const PodcastsEntreprise: React.FC = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      Partenaires: "bg-gradient-to-r from-[#6B8E23] to-[#7BA05B]",
      Réunion: "bg-gradient-to-r from-[#8B4513] to-[#A0522D]",
      Tourisme: "bg-gradient-to-r from-[#2E8B57] to-[#3CB371]",
  ...
  if (loading) {
    return <LoadingSpinner text="Chargement des vidéos Entreprise" />;
  }
          ...
          <div className="hidden lg:flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              <div className="p-3 bg-gradient-to-br from-[#6B8E23]/20 to-[#7BA05B]/20 rounded-2xl border border-[#6B8E23]/30">
                <Building className="w-8 h-8 text-[#6B8E23]" />
              </div>
              <div>
                ...
                <div className="p-3 sm:p-4 border-t border-gray-700 bg-gray-900/50">
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className="p-2 bg-gradient-to-r from-[#6B8E23] to-[#7BA05B] hover:from-[#556B2F] hover:to-[#6B8E23] text-white rounded-lg transition-all duration-200 border border-[#6B8E23]/50 text-xs shadow-md"
                    >
