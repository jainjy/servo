      ...
      try {
        ...
        if (apiData.success && Array.isArray(apiData.data)) {
          ...
          const bienEtreVideos: VideoEpisode[] = apiData.data
            .filter((video: any) => {
              const isBienEtre = video.category === "Bien-être";
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16 ">
          <div className="flex relative items-center justify-center mb-8">
            <div className="flex mb-10 lg:pb-4 pb-10 items-center flex-col justify-center space-x-4">

              <h2 className="text-xl lg:text-4xl text-center pb-2 lg:pb-10 font-bold text-gray-100">Podcasts Bien-être</h2>
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-3 sm:p-4 border-b border-gray-700">
                  <div className="flex items-center space-x-3 mb-3">
                    {/* Avatar */}
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-green-600 to-green-500 rounded-full flex items-center justify-center shadow-lg">
