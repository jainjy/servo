...
const PodcastsBatiment: React.FC = () => {
      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            <div className="grid lg:flex items-center space-x-4 text-sm text-gray-500">
  ...
  if (loading) {
    return (
 <LoadingSpinner text='Chargement des vidéos Bâtiment & Construction'/>
    );
  }
        ...
        <section className="mb-16">
          ...
          <div className="flex gap-4 mb-8 border-b border-gray-200">
            <button
              ...
              className={`pb-4 px-0 lg:px-6 font-semibold text-lg transition-all duration-300 border-b-2 ${activeTab === 'all'
                  ? 'border-orange-600 text-orange-600'
                  : 'border-transparent text-gray-600 hover:text-gray-900'
                }`}
            >
              <div className="lg:text-lg text-xs flex items-center space-x-2">
            ...
            <button
              ...
              className={`pb-4 px-0 lg:px-6 font-semibold text-lg transition-all duration-300 border-b-2 ${activeTab === 'favorites'
