      ...
      {isModalOpen && selectedEpisode && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
          ...
          <div className="relative w-full max-w-7xl h-[90vh] bg-gray-900/50 rounded-2xl shadow-2xl overflow-hidden flex">
            ...
            <div className="flex-1 mr-4 rounded-t-lg overflow-hidden flex flex-col min-w-0">
              {/* Container vidéo */}
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-4 border-b border-gray-700">
                  <div className="flex items-center space-x-3 mb-3">
                    {/* Avatar */}
                    <div className="w-10 h-10 bg-gradient-to-br from-amber-600 to-amber-500 rounded-full flex items-center justify-center shadow-lg">
                ...
                <div className="p-4 border-y border-gray-700">
                  <div className="flex space-x-2">
                    <button
                      onClick={handlePlayMedia}
                      className="flex-1 flex items-center justify-center space-x-2 bg-amber-600 hover:bg-amber-700 text-white py-2 rounded-lg font-semibold transition-all duration-200"
                    >
                      {isPlaying ? (
                        <>
