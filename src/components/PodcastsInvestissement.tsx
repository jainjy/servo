...
import { Play, Headphones, Clock, Heart, Star, Download, Video, TrendingUp, BarChart3 } from 'lucide-react';
...
const PodcastsInvestissement: React.FC = () => {
  ...
  const headerBackgroundImage = "https://i.pinimg.com/1200x/ed/1e/94/ed1e94483f042c61f00d0ac4998192f5.jpg";
  ...
  // Charger les vidéos de la catégorie Investissement
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        ...
        console.log('🔄 Début du chargement des vidéos Investissement...');
        ...
        if (apiData.success && Array.isArray(apiData.data)) {
          ...
          const investissementVideos: VideoEpisode[] = apiData.data
            .filter((video: any) => {
              const isInvestissement = video.category === "Investissement";
              ...
              console.log('📋 Filtrage vidéo:', {
                ...
                isInvestissement: isInvestissement,
                isActive: isActive,
                hasVideoUrl: hasVideoUrl,
                videoUrl: video.videoUrl
              });

              const shouldInclude = isInvestissement && isActive && hasVideoUrl;
          ...
          console.log('🎉 Vidéos Investissement après filtrage:', investissementVideos.length);
          console.log('📺 Liste complète des vidéos filtrées:', investissementVideos);

          setVideoEpisodes(investissementVideos);

          if (investissementVideos.length === 0) {
  ...
  const VideoCard = ({ episode }: { episode: VideoEpisode }) => {
    ...
    return (
      <div
        className={`bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border group ${episode.featured ? 'border-2 border-blue-700' : 'border-gray-200'
          }`}
      >
        {episode.featured && (
        ...
        <div className="p-6">
          ...
          <h4 className="font-bold text-lg text-gray-900 mb-3 group-hover:text-amber-600 transition-colors line-clamp-2">
            {episode.title}
          </h4>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <button
              ...
              className="flex items-center px-4 py-2 rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors group/btn"
            >
      ...
      <div className="min-h-screen bg-white">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col justify-center items-center h-64">
            ...
            <div className="text-gray-600">Chargement des vidéos Investissement...</div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div
        className="relative py-10 mt-10 bg-cover bg-center bg-no-repeat"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <h1 className="text-4xl md:text-4xl font-bold mb-6 leading-tight">
              Podcast <span className="text-amber-400">Investissement</span>
            </h1>

            {/* Sous-titre */}
            <p className="text-sm md:text-md text-gray-200 max-w-3xl mx-auto leading-relaxed mb-8">
              Maîtrisez les stratégies d'investissement, analysez les marchés financiers et développez votre patrimoine
            </p>
            ...
            <div className="flex flex-wrap justify-center items-center gap-6">
              ...
              <div className="relative group">
                <div className="flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-6 py-4 shadow-2xl transition-all duration-500 hover:bg-white/15 hover:border-white/30">
                ...
                {/* Effet de lueur */}
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
              </div>

              {/* Badge Vidéos Disponibles */}
              <div className="relative group">
                <div className="flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-6 py-4 shadow-2xl transition-all duration-500 hover:bg-white/15 hover:border-white/30">
                  <div className="p-3 bg-white/10 rounded-xl border border-white/10 backdrop-blur-sm">
                ...
                {/* Effet de lueur */}
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="hidden lg:flex items-center justify-between mb-8">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Formations vidéo, analyses de marché et stratégies d'investissement</p>
              </div>
            </div>
              ...
              <div className="text-center py-16 bg-white rounded-2xl shadow-lg border">
                ...
                <p className="text-gray-500">
                  {error
                    ...
                    : "Aucune vidéo investissement n'est disponible pour le moment"
                  }
                </p>
              </div>
            )
      ...
      {isModalOpen && selectedEpisode && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md">
          ...
          <div className="relative w-full max-w-7xl h-[95vh] sm:h-[90vh] bg-gray-900/50 rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
            ...
            <div className="flex-1 lg:mr-4 rounded-t-xl sm:rounded-t-2xl overflow-hidden flex flex-col min-w-0">
              {/* Container vidéo */}
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-3 sm:p-4">
                  ...
                  <div className="mb-3 sm:mb-4 px-1 sm:px-2">
                    ...
                    >
                      ...
                      <div
                        className="absolute h-full bg-amber-600 rounded-full transition-all duration-100"
                        style={{ width: `${progress}%` }}
                      ></div>
                      <div
                        className="absolute top-1/2 w-3 h-3 bg-amber-600 rounded-full transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-lg"
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-3 sm:p-4 border-b border-gray-700">
                  <div className="flex items-center space-x-3 mb-3">
                    {/* Avatar */}
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-amber-600 to-amber-500 rounded-full flex items-center justify-center shadow-lg">
                      <Video className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                    </div>
                    <div>
                      <div className="text-sm font-semibold text-white">Médias</div>
                      <div className="text-xs text-gray-400">Contenu vidéo</div>
                    </div>
                  </div>
                ...
                <div className="p-3 sm:p-4 border-t border-gray-700 bg-gray-900/50">
                  <div className="flex space-x-2">
                    <button
                      onClick={handlePlayMedia}
                      className="flex-1 flex items-center justify-center space-x-2 bg-amber-600 hover:bg-amber-700 text-white py-2 rounded-lg font-semibold transition-all duration-200 text-xs sm:text-sm"
                    >
                      {isPlaying ? (
                        <>
