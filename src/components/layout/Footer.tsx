...
const Footer: React.FC = () => {
  ...
  const partners = [
    ...
    // },
    {
      ...
      logo: "/logo_REUNIREM_DIAGNOSTIC.png",
    },
    {
      name: "IBR Ingénierie",
        ...
        <div className="flex flex-col md:flex-row justify-around gap-3">
          ...
          <div className="md:col-span-2 lg:col-span-4">
            <div className="mb-2 flex items-center gap-2">
              <img src="/golo.png" alt="Logo Oliplus" className="h-20 w-auto" />
              ...
              {[
                {
                  ...
                  url: "https://www.facebook.com/profile.php?id=61587021448271"
                },
                {
                  name: "WhatsApp",
                  color: "bg-[#25D366]",
