...
export default function InteractivePortrait() {
  ...
  useEffect(() => {
    ...
    class Blob {
      ...
      constructor(renderer: THREE.WebGLRenderer) {
        ...
        const handleMouseMove = (event: MouseEvent) => {
          ...
          gu.isHovering.value = true
        }

        const handleMouseLeave = () => {
          this.uniforms.pointer.value.setScalar(10)
          gu.isHovering.value = false
        }
    ...
    const baseTexture = textureLoader.load("/", (texture) => {
    ...
    bgPlaneMaterial.onBeforeCompile = (shader) => {
      ...
      `.replace(
        ...
        // 1. Define as cores
        vec3 colorBg = vec3(0.145, 0.173, 0.114);  // #252c1d
vec3 colorSoftShape = vec3(0.0, 0.0, 0.0);
vec3 colorLine = vec3(0.2, 0.2, 0.2);
