...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
      <div className="h-2/3 top-20 w-11/12 lg:h-screen rounded-lg overflow-hidden bg-lack absolute">
        <img
          src={heroImage}
          alt="Background"
      ...
      <div className="container relative z-10 mx-auto px-4 py-20 text-center">
        <h1 className="mb-6 lg:mt-0 -mt-2 text-2xl azonix md:text-5xl lg:text-7xl font-extrabold text-white">
