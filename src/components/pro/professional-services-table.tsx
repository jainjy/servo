...
import ServiceModal from "./Pro-oeuvre-modal"
...
export function ProfessionalServicesTable({
  ...
  const fetchServices = async () => {
    try {
      ...
      if (activeTab === "available") endpoint = "/professional/services/available"
  ...
  const handleAssociateService = async (serviceId: number) => {
    try {
