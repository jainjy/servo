  ...
  const faqs: FAQItem[] = [
    {
      ...
      image:
        "https://i.pinimg.com/1200x/91/e7/61/91e761120ecac64ef8187e657d49243a.jpg",
      stats: {
    ...
    },
    {
      ...
      answer:
        "Absolument ! Nous proposons des expériences nocturnes magiques : observation des étoiles avec télescope, randonnées au clair de lune, soirées contes autour du feu, et dégustations de produits locaux sous les étoiles. Ces moments créent des souvenirs inoubliables dans une ambiance unique.",
      category: "Nocturne",
      icon: <Moon className="w-4 h-4" />,
      image:
        "https://i.pinimg.com/736x/d3/aa/81/d3aa8108a58d0afa74cbc5cc917b621f.jpg",
      stats: {
    ...
    },
    {
      ...
      answer:
        "Oui, nous organisons diverses activités nautiques selon la saison : paddle sur les lacs alpins, baignade dans les gorges, pêche initiatique, et découverte de la faune aquatique. Toutes nos activités respectent l'environnement et sont encadrées par des moniteurs brevetés.",
      category: "Aquatique",
      icon: <Waves className="w-4 h-4" />,
      image:
        "https://i.pinimg.com/736x/c3/7d/bb/c37dbbd5da75fe7a956e189cbf996870.jpg",
      stats: {
    ...
    },
    {
      ...
      answer:
        "Pas de panique ! Nous avons des solutions alternatives : visite de caves de dégustation, ateliers artisanaux locaux (poterie, fromage), escape game thématisé, ou découverte des musées régionaux. Chaque activité d'intérieur est tout aussi passionnante et authentique.",
      category: "Intérieur",
      icon: <Tent className="w-4 h-4" />,
      image:
        "https://i.pinimg.com/1200x/41/92/dd/4192dd706c513e89390271780c3577ab.jpg",
      stats: {
    ...
    },
    {
      ...
      answer:
        "Spécialement conçues pour les familles, nos activités mêlent aventure et pédagogie : chasse au trésor nature, initiation à l'orientation, découverte de la faune locale, ateliers créatifs en plein air. Les enfants repartent avec des souvenirs magiques et de nouvelles connaissances !",
      category: "Famille",
      icon: <TreePine className="w-4 h-4" />,
      image:
        "https://i.pinimg.com/736x/5a/3d/ec/5a3dec4079607dc09653197662975eef.jpg",
      stats: {
    ...
    },
    {
      ...
      answer:
        "Pour les plus sportifs, nous organisons des challenges : trail découverte, via ferrata, descente en rappel, ou parcours aventure dans les arbres. Ces activités demandent une bonne condition physique mais restent accessibles avec notre encadrement professionnel.",
      category: "Sportif",
      icon: <Trophy className="w-4 h-4" />,
      image:
        "https://i.pinimg.com/736x/8a/3b/d8/8a3bd8d9a5d4e7b4e5a8c6e3f7b2a1e5.jpg",
      stats: {
    ...
    },
    {
      ...
      answer:
        "Détendez-vous avec nos expériences bien-être : yoga en pleine nature, méditation guidée au bord d'un lac, bain de forêt (shinrin-yoku), ou relaxation sonore avec les bruits de la nature. Un véritable ressourcement pour le corps et l'esprit.",
      category: "Bien-être",
      icon: <Zap className="w-4 h-4" />,
      image:
        "https://i.pinimg.com/736x/9f/8a/dc/9f8adc7a8b5e6c7a3e4f5b8c9a6d7e8f.jpg",
      stats: {
        participants: "2-8 personnes",
        duration: "2-3 heures",
      ...
      <div className="relative py-8 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-md text-slate-200 max-w-3xl mx-auto leading-relaxed">
            Découvrez nos activités touristiques uniques - Des expériences
            inoubliables
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {categories.map((category) => (
            <button
              ...
              className={`flex items-center gap-3 px-6 py-3 rounded-full border-2 transition-all duration-300 font-semibold text-sm shadow-lg hover:scale-105 ${
                        ...
                        {faq.features && (
                          <div className="grid grid-cols-2 gap-3">
                            {faq.features.map((feature, idx) => (
                              <div
                                key={idx}
                                className="bg-slate-700/80 text-slate-200 px-4 py-3 rounded-xl text-sm font-medium border border-slate-600 text-center"
                              >
                                {feature}
                              </div>
                            ))}
      ...
      <div className="bg-[#9B177E] border-y border-purple-500/30 mx-4 rounded-2xl text-white py-16 mb-8 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-md text-slate-300 mb-8 max-w-2xl mx-auto">
            Rejoignez-nous pour des expériences uniques et créez des souvenirs
            inoubliables dans les plus beaux paysages de notre région
          </p>
