...
const PodcastsAlimentation: React.FC = () => {
  ...
  // Charger les vidéos de la catégorie Alimentation
  useEffect(() => {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <h1 className="text-xl md:text-4xl font-bold mb-6 leading-tight">
              Podcast <span className="text-orange-400">Alimentation</span>
            </h1>
            ...
            {/* Statistiques */}
            <div className="grid grid-cols-2 lg:flex flex-wrap justify-center items-center gap-6">
              {/* Badge Vues Totales */}
              <div className="relative group">
                <div className="flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-2 lg:px-6 py-4 shadow-2xl transition-all duration-500 hover:bg-white/15 hover:border-white/30">
              ...
              <div className="relative group">
                ...
                {/* Effet de lueur */}
                <div className="absolute inset-0 bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10" />
              </div>
            </div>
          </div>
        </div>
