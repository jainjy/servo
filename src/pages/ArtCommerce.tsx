...
import { Search, Store, Palette, Truck, MapPin, Plus, Mail, Phone, Star, ExternalLink, X } from 'lucide-react';
...
const ArtCommerce = () => {
  ...
  const categories = [
    { id: 'all', name: 'Tous', icon: Store, color: 'bg-gradient-to-r from-blue-500 to-cyan-500' },
    { id: 'peinture', name: 'Peintures', icon: Palette, color: 'bg-gradient-to-r from-purple-500 to-pink-500' },
    { id: 'sculpture', name: 'Sculptures', icon: Palette, color: 'bg-gradient-to-r from-emerald-500 to-teal-500' },
    { id: 'artisanat', name: 'Artisanat', icon: Store, color: 'bg-gradient-to-r from-amber-500 to-orange-500' },
    { id: 'boutique', name: 'Boutiques', icon: Store, color: 'bg-gradient-to-r from-rose-500 to-red-500' }
  ];
  ...
  const listings = [
    {
      ...
      hasWebsite: true,
      delivery: true,
      description: "Galerie d'art spécialisée dans les œuvres tropicales et locales. Nous mettons en valeur les artistes réunionnais.",
      contact: {
    ...
    },
    {
      ...
      hasWebsite: false,
      delivery: true,
      description: "Sculptures sur bois authentiques réalisées par des artisans locaux avec des essences de La Réunion.",
      contact: {
    ...
    },
    {
      ...
      hasWebsite: true,
      delivery: false,
      description: "Artisanat local : vannerie, broderie, et créations uniques des artisans réunionnais.",
      contact: {
    ...
    },
    {
      ...
      hasWebsite: true,
      delivery: true,
      description: "Œuvres contemporaines et abstraites dans un espace dédié à l'art moderne réunionnais.",
      contact: {
    ...
    },
    {
      ...
      hasWebsite: false,
      delivery: true,
      description: "Artisanat traditionnel aux couleurs vives de l'île de La Réunion.",
      contact: {
    ...
    },
    {
      ...
      hasWebsite: true,
      delivery: false,
      description: "Sculptures métalliques et installations artistiques jouant avec la lumière tropicale.",
      contact: {
      ...
      <div className="bg-white rounded-xl p-6 max-w-2xl w-full border border-gray-200 max-h-[90vh] overflow-y-auto shadow-2xl relative">
        ...
        <form className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-slate-700 text-sm font-medium mb-2">Nom du commerce *</label>
              <input 
                type="text" 
                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                required 
          ...
          <div>
            <label className="block text-slate-700 text-sm font-medium mb-2">Localisation *</label>
            <input 
              type="text" 
              className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-slate-700 text-sm font-medium mb-2">Téléphone</label>
              <input 
                type="tel" 
                className="w-full bg-gray-50 border border-gray-300 rounded-lg px-3 py-2 text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <label htmlFor="hasWebsite" className="text-slate-700 text-sm font-medium">Site web disponible</label>
          </div>
          ...
          <div className="flex items-center gap-3">
            <input 
              ...
              className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" 
            />
            <label htmlFor="delivery" className="text-slate-700 text-sm font-medium">Livraison disponible</label>
          </div>
          
          <div className="pt-4 border-t border-gray-200">
            <p className="text-blue-600 text-sm mb-4 bg-blue-50 p-3 rounded-lg border border-blue-200">
              💡 Votre commerce sera visible après validation manuelle par notre équipe
            </p>
            <div className="flex gap-3">
              <button 
                type="button"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
                ...
                >
                  <div className="h-48 relative overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className={`${category?.color || 'bg-blue-500'} text-white px-2 py-1 rounded-lg text-xs font-semibold shadow-lg`}>
                        {category?.name}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    <h3 className="font-bold text-lg mb-3 text-slate-900 group-hover:text-blue-600 transition-colors">{item.title}</h3>
      ...
      >
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Vous êtes commerçant ?</h2>
          <p className="text-lg text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
            Rejoignez notre plateforme pour seulement <strong className="text-white">39€/mois</strong> et boostez votre visibilité
          </p>
