...
function TourismBookingDetailsModal({ booking, open, onOpenChange }: { 
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                {booking.listing.amenities && booking.listing.amenities.length > 0 && (
                                    <div>
                                        <h4 className="font-medium text-sm mb-2">Équipements :</h4>
                                        <div className="flex flex-wrap gap-1">
                                            {booking.listing.amenities.slice(0, 5).map((amenity, index) => (
                                ...
                                <CardContent className="space-y-3">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium capitalize">
                                            {booking.paymentMethod === 'card' ? 'Carte bancaire' : booking.paymentMethod}
                                        </span>
                                    </div>
                                    <div className="flex justify-between">
                                        ...
                                        <Badge variant={
                                            ...
                                            {booking.paymentStatus === 'paid' ? 'Payé' : 
                                             booking.paymentStatus === 'pending' ? 'En attente' : 'Échoué'}
                                        </Badge>
                                    </div>
                                </CardContent>
                            </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-2">
                                <div className="flex justify-between">
                                    <span>{booking.listing.price}€ × {nights} nuit{nights > 1 ? 's' : ''}</span>
                                    <span>{formatCurrency(booking.listing.price * nights)}</span>
                                </div>
                                <div className="flex justify-between text-sm text-muted-foreground">
                                    <span>Frais de service</span>
                                    <span>{formatCurrency(booking.amount - (booking.listing.price * nights))}</span>
                                </div>
...
function ServiceBookingDetailsModal({ booking, open, onOpenChange }: { 
...
export default function UnifiedReservationPage() {
    ...
    const cancelTourismBooking = async (id: string) => {
        try {
            ...
            if (response.data.success) {
                setTourismBookings(prev => prev.map(b => 
                        ...
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>
                                        {tourismBookings.length} réservation{tourismBookings.length > 1 ? 's' : ''} trouvée{tourismBookings.length > 1 ? 's' : ''}
                                    </CardDescription>
                                </div>
                                <div className="flex items-center gap-2">
                                                        ...
                                                        <TableCell className="text-right">
                                                            <div className="flex items-center justify-end gap-2">
                                                                <Button 
                                                                    variant="outline" 
                                                                    size="sm"
                                                                    onClick={() => handleShowTourismDetails(booking)}
                                                                >
                                                                    Détails
                                                                </Button>
                                                                {booking.status !== "annulee" && booking.status !== "terminee" && (
                                                                    <Dialog>
                                                                        ...
                                                                        <DialogContent>
                                                                            ...
                                                                            <DialogFooter>
                                                                                <Button
                                                                                    variant="destructive"
                                                                                    onClick={() => cancelTourismBooking(booking.id)}
                                                                                >
                    ...
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <Select defaultValue="all" onValueChange={(v) => setServiceFilter(v)}>
                                        <SelectTrigger className="w-48">
                                            <SelectValue placeholder="Filtrer par statut" />
                                        </SelectTrigger>
                                        <SelectContent>
                                                    ...
                                                    <TableCell className="text-right">
                                                        <div className="flex items-center justify-end gap-2">
                                                            <Button 
                                                                variant="outline" 
                                                                size="sm" 
                                                                onClick={() => handleShowServiceDetails(booking.id)}
                                                            >
                                                                Détails
                                                            </Button>
                                                                ...
                                                                <Dialog>
                                                                    ...
                                                                    <DialogContent>
                                                                        ...
                                                                        <DialogFooter>
                                                                            <Button
                                                                                variant="destructive"
                                                                                onClick={() => cancelServiceBooking(booking.id)}
                                                                            >
                                                                                Confirmer l'annulation
                                                                            </Button>
                                                                        </DialogFooter>
