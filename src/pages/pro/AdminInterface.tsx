...
const AdminInterface: React.FC<AdminInterfaceProps> = ({
  ...
  const getAddButtonText = () => {
    switch (contentType) {
      case "accommodations":
        return "Ajouter un hébergement";
      case "touristic_places":
        return "Ajouter un lieu touristique";
      case "flights":
    ...
    <div className="space-y-6">
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-black">
                  {currentContentType?.label || "Sélectionner"}
                </span>
              </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <div className="text-2xl font-bold text-black">
                  {activities.length > 0
                    ? Math.min(
                        ...activities.map((a) => a.price || Infinity),
                      ) === Infinity
                      ? 0
      ...
      naturePatrimoineLoading ? (
        <div className="text-center flex flex-col items-center justify-center py-20 bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl">
          ...
          <p className="mt-4 text-xl font-semibold text-black">Chargement...</p>
        </div>
      ) : (
        <>
                ...
                <>
                  ...
                  <div className="flex items-center justify-between pt-8 border-t border-[#D3D3D3]">
                    <div className="text-[#556B2F]">
                      ...
                      site{naturePatrimoine.length > 1 ? "s" : ""}
                    </div>
