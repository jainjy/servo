// ProductCreateModal.tsx - VERSION FINALE AVEC UPLOAD RÉEL
...
const Type = ['Peinture', 'Sculpture', 'Dessin', 'Artisanat','photographie'];
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        {Type.map((cat) => (
                          <SelectItem key={cat} value={cat} className="focus:bg-[#6B8E23]/10">
                            {cat}
                          </SelectItem>
                        ))}
                      </SelectContent>
