    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 p-6 hover:border-blue-300 hover:shadow-lg transition-all duration-300 group relative">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Informations du demandeur</h4>
                    <div className="text-sm text-gray-600">
                        <p><span className="font-medium">Nom :</span> {demande.contactPrenom} {demande.contactNom}</p>
                        <p><span className="font-medium">Email :</span> {demande.contactEmail}</p>
                        <p><span className="font-medium">Téléphone :</span> {demande.contactTel}</p>
                    </div>
                </div>
                <div>
                    <h4 className="text-sm font-medium text-gray-700 mb-2">Détails de la visite</h4>
                    <div className="text-sm text-gray-600">
                        <p><span className="font-medium">Date souhaitée :</span> {new Date(demande.dateSouhaitee).toLocaleDateString('fr-FR')}</p>
                        <p><span className="font-medium">Heure souhaitée :</span> {demande.heureSouhaitee}</p>
                        <p><span className="font-medium">Message :</span> {formatMessage(demande.description)}</p>
                    </div>
                </div>
            </div>
