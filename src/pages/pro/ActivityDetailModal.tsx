...
import { X, MapPin, Clock, Users, CheckCircle, Edit, Trash2 } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {activity.category && (
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="font-semibold text-black">{activity.category}</div>
              </div>
            )}
            ...
            {activity.duration && (
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="font-semibold text-black">{activity.duration}</div>
              </div>
            )}
