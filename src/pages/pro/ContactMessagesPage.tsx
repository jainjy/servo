          ...
          <Card>
            <CardContent className="p-3 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
                ...
                <MessageSquare className="h-6 sm:h-8 w-6 sm:w-8 text-blue-500 flex-shrink-0" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-3 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
                ...
                <EyeOff className="h-6 sm:h-8 w-6 sm:w-8 text-red-500 flex-shrink-0" />
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="col-span-2 sm:col-span-1">
            <CardContent className="p-3 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
                ...
                <Archive className="h-6 sm:h-8 w-6 sm:w-8 text-gray-500 flex-shrink-0" />
              </div>
            </CardContent>
          </Card>
        </div>
            ...
            {filteredMessages.length === 0 ? (
              <Card>
                <CardContent className="p-6 sm:p-8 text-center">
                  <MessageSquare className="h-10 sm:h-12 w-10 sm:w-12 text-gray-300 mx-auto mb-4" />
      ...
      <AlertDialog open={showReplyModal} onOpenChange={setShowReplyModal}>
        <AlertDialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0">
          ...
          <div className="px-4 sm:px-6 py-4">
            <AlertDialogDescription className="mb-4 text-sm">
          ...
          <div className="sticky bottom-0 bg-white border-t p-4 sm:p-6 flex flex-col sm:flex-row gap-2 justify-end">
