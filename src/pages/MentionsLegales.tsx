...
// Composant Mentions Légales mis à jour pour :
// - afficher le PDF (intégration via iframe/object)
// - bouton pour télécharger le PDF
// - champs mis à jour à partir de l'extrait Kbis fourni (ex. immatriculation, capital, adresse...)
// Utilisation :
// - Déposez le fichier PDF dans le dossier public de votre app sous le nom `mentions-legales.pdf`
//   OU passez `pdfUrl` en prop vers l'URL publique du PDF.

export default function MentionsLegales({ pdfUrl }) {
  const navigate = useNavigate();
  // Par défaut, on attend que le PDF soit dans le dossier public
  const publicPdfUrl =
    pdfUrl || `/mentions-legales-oliplus.pdf`;

  const downloadPdf = async () => {
    try {
      const res = await fetch(publicPdfUrl, { cache: "no-store" });
      if (!res.ok) throw new Error("Impossible de récupérer le PDF");
      const blob = await res.blob();
      const url = window.URL.createObjectURL(new Blob([blob]));
      const link = document.createElement("a");
      link.href = url;
      link.setAttribute("download", "mentions-legales-oliplus.pdf");
      ...
      alert(
        "Erreur lors du téléchargement du PDF. Vérifiez que le fichier existe à l'URL indiquée.",
      );
    }
  };
      ...
      <div className="max-w-7xl mx-auto pt-10">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Date fixe tirée du Kbis fourni */}
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border-l-4 border-logo">
            ...
            <div className="space-y-4 grid grid-cols-1 lg:grid-cols-2 pl-11">
              ...
              <div className="pb-3 border-b border-gray-100 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-300">500,00 €</p>
              </div>
              ...
              <div className="pb-3 border-b border-gray-100 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  45 Rue Monseigneur De Beaumont, 97400 Saint-Denis
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  N° d'immatriculation RCS : 943 536 540 - R.C.S. Saint Denis de
                  La Réunion
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">24/04/2025</p>
              </div>
            </div>
          </section>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                    Contactez notre Délégué à la Protection des Données pour
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 pl-11">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-white">
                    45 rue monseigneur de Beaumont Saint Denis
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border-l-4 border-yellow-500">
            ...
            <div className="space-y-4 pl-11">
              <p className="text-gray-700 dark:text-gray-300">
                L'ensemble des éléments composant le site OLIPLUS Platform
                (textes, graphismes, logos, images, sons, vidéos, etc.) sont la
                propriété exclusive de OLIPLUS Platform ou de ses partenaires.
              </p>
          ...
          <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border-l-4 border-gray-500">
            ...
            <div className="space-y-4 pl-11">
              <p className="text-gray-700 dark:text-gray-300">
                OLIPLUS Platform met tout en œuvre pour assurer l'exactitude et
                la mise à jour des informations diffusées sur son site.
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 italic">
                <p className="text-gray-700 dark:text-gray-300">
                  OLIPLUS Platform décline toute responsabilité pour tout
                  dommage direct ou indirect résultant de l'accès ou de
          ...
          <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border-l-4 border-indigo-500">
            ...
            <div className="space-y-4 pl-11">
              <p className="text-gray-700 dark:text-gray-300">
                ...
                Francaise. En cas de litige, et à défaut de résolution amiable,
                les tribunaux compétents seront ceux de France.
              </p>
              <div className="bg-indigo-50 dark:bg-indigo-900/10 rounded-lg p-4">
                <p className="text-gray-700 dark:text-gray-300 font-medium">
                  Conformément aux dispositions du RGPD, vous disposez également
          ...
          <section className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                <Download className="w-5 h-5" /> Document Kbis
              </h3>
              <Button
                onClick={downloadPdf}
                variant="secondary"
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Téléchargez notre extrait Kbis en cliquant sur le bouton ci-dessus pour vérifier nos informations légales et d'immatriculation.
            </p>
          </section>
          ...
          <section className="bg-logo rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              ...
              interrogations concernant nos mentions légales et notre politique
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={() =>
                  (window.location.href = "mailto:contact@oliplus.fr")
                }
              >
