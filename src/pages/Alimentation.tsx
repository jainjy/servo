      ...
      <div className="bg-white rounded-3xl max-w-md w-full animate-scale-in">
        ...
        <div className="p-6">
          ...
          <div className="mt-6 flex gap-3">
            <Button
              className="flex-1 bg-blue-600 hover:bg-[#00A890] text-white"
              onClick={() => {
  ...
  return (
    <div className="min-h-screen relative pt-16 overflow-hidden bg-[#F6F8FA]">
      ...
      <div className="absolute top-20 left-10 animate-float z-2">
        <Apple className="h-8 w-8 text-blue-600/40" />
      </div>
      <div
        className="absolute top-40 right-20 animate-float z-2"
        style={{ animationDelay: "1s" }}
      >
        <Leaf className="h-6 w-6 text-blue-600/40" />
      </div>
      <div
        className="absolute bottom-40 left-20 animate-float z-2"
        style={{ animationDelay: "2s" }}
      >
        <Carrot className="h-5 w-5 text-blue-600/40" />
      </div>
        ...
        <section className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white/90 py-5 rounded-lg backdrop-blur-sm">
            <div className="text-center mb-5 animate-fade-in">
              <h1 className=" text-xl lg:text-5xl md:text-4xl font-bold mb-4 text-slate-900">
            ...
            >
              <div className="relative group">
                <Input
                  ...
                  className="w-full h-12 sm:h-14 lg:h-16 pl-10 sm:pl-12 lg:pl-16 pr-16 sm:pr-32 lg:pr-8 rounded-xl sm:rounded-2xl border-2 text-xs sm:text-sm lg:text-lg text-start font-semibold uppercase tracking-wide transition-all duration-300 group-hover:shadow-lg border-blue-600/30 bg-white/80 backdrop-blur-md focus:border-blue-600 focus:ring-2 focus:ring-[#00C2A8]/20"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                />

                <Search className="absolute left-3 sm:left-4 lg:left-6 top-1/2 -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 text-blue-600 transition-transform duration-300 group-hover:scale-110 group-focus-within:scale-110" />

                <Button
                  type="submit"
                  className="absolute right-1 top-1/2 -translate-y-1/2 h-10 sm:h-11 lg:h-12 px-3 sm:px-4 lg:px-6 bg-blue-600  text-white rounded-lg sm:rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl text-xs sm:text-sm lg:text-base font-medium disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                  disabled={isLoading}
                >
                  {isLoading ? (
            ...
            >
              <Badge className="bg-blue-600/10 text-blue-600 border-0 px-4 py-2">
          ...
          {filteredSections.map((section, sectionIndex) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="p-3 rounded-2xl bg-blue-600 shadow-lg transform transition-transform duration-300 hover:scale-110">
                    ...
                    return (
                      ...
                      >
                        <div className="relative flex mx-auto overflow-hidden bg-black/15 w-full h-32 rounded-md mb-4">
                          ...
                          />
                          <div className="flex justify-end absolute bg-blue-600 rounded-full text-white bottom-2 right-2">
                        ...
                        <Button
                          className="w-full bg-blue-600/10 hover:bg-blue-600 hover:text-white text-blue-600 border-0 transition-all duration-300 group-hover:shadow-lg group-hover:scale-105"
          ...
          >
            <div className="bg-white/80 backdrop-blur-md rounded-3xl p-4 lg:p-12 border border-white/20 shadow-2xl">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <Button
                  className="bg-blue-600 hover:bg-[#00A890] text-white px-8 py-3 text-lg rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl animate-pulse-cta"
                  onClick={() => handleContactClick("contact")}
                >
                  Commander maintenant
                </Button>
                <Button
                  className="bg-white hover:bg-gray-50 text-blue-600 border-2 border-blue-600 px-8 py-3 text-lg rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl"
